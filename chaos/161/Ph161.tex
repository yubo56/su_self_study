...
is stable/unstable for $\epsilon$ values, the point being that we analyze every
other time step and so observe period doubling.
...
for successive bifurcation points $a_n$, the period double to $2^n$ times the
base frequency.
