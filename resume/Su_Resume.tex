...
\def\ResearchSec{
    ...
    \begin{tightemize}
        \item Working with \textbf{\href
               ...
               {Prof.\ Dong Lai}
            } to explore numerically energy and angular momentum distribution by
            nonlinear wave breaking of internal tidal excitations in white dwarfs.
        \item Working with Sr.\ Research Associate Henrik Spoon on webpage to
            disseminate diagnostics for \emph{The Infrared Database of Extragalactic
            Observables from Spitzer}, to go live at \url{
                http://ideos.astro.cornell.edu
            }.
        \item High performance computing, numerical fluid dynamics, theoretical
            astrophysics.
    \end{tightemize}
    \sectionsep
