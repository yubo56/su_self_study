...
\begin{itemize}
    ...
    \item $\bm{R}$ is a fickle object, subject to perturbation e.g.\ by
        gravitational waves. A certain piece of the tensor is generated only
        by the local mass distribution though, $\bm{G}$ the \emph{Einstein
        curvature tensor}, incidently proportional to the \emph{stress-energy
        tensor} as $\bm{G} = 8\pi \bm{T}$. Its interpretation is a local
        average curvature.
\end{itemize}
