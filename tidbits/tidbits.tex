...
\begin{figure}[!h]
    ...
    a=0.5$, or a uniform sampling $[0,1]$. Sampled over $3^{[1, 12]}$.}
\label{fig:1-medians}
\end{figure}
...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{Seems asymptotically close to $\sqrt{2}$ maybe?}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{medians_ratio_to_mean.png}
        \caption{Seems asymptotically close to $1/3$ maybe?}
    \end{subfigure}
...
\end{align}
and we get something even worse. It's 2:30AM on a Sunday night/Monday morning
and I have work tomorrow, but I will come back to this eventually\dots
