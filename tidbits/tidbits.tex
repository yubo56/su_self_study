...
\section{Generalized Melnikov Method Derivation}

In MATH6270, we discussed the Melnikov method for a weakly dissipitive
Hamiltonian system. Wiggins has a chapter in his book \emph{Global Bifurcations
and Chaos} that generalizes this to a large number of systems. We may include
this proof in a future paper, but we should work through it here; we cast the
proof for a Hamiltonian system with adiabatically varying parameter and a weak
non-Hamiltonian perturbation in familiar notation.
