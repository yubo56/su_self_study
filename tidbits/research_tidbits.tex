...
According to Fabrycky \& Tremaine 2007, the orbit average gravitational
potential is
\begin{equation}
    \Phi_{\rm rot}
        =
            -\frac{m_1m_2}{3a^3 j^3}
            \sum\limits_i
...
\begin{equation}
    \Phi_{\rm rot, i}
        \propto
            \frac{3\p{\uv{\Omega} \cdot \bm{j}}^2}{j^5}
            - \frac{1}{j^3}.
\end{equation}
    ...
    \rd{\bm{e}}{t}
        &=
            -\frac{1}{L}\p{\bm{e} \times \nabla_{\bm{j}}\Phi
                + \bm{j} \times \nabla_{\bm{e}}\Phi},\\
        &=
            -\frac{1}{L}\bm{e} \times \s{
                -\frac{15\bm{j}\p{\uv{\Omega} \cdot \bm{j}}^2}{j^7}
                + \frac{6\uv{\Omega}\p{\uv{\Omega} \cdot \bm{j}}}{j^5}
                + \frac{3\bm{j}}{j^5}
            },\\
        &\propto
            -\frac{1}{6j^4}\s{
                - \frac{5\cos^2\theta - 1}{2}(\bm{e} \times \uv{\jmath})
                + (\bm{e} \times \uv{\Omega})\cos\theta
            }.
\end{align}
