...
//
// Keycodes are @ ~/qmk_firmcare/docs/keycodes.md
...
(
    ...
    KC_NO , RGB_VAD , RGB_VAI  , RGB_HUD , RGB_HUI , KC_NO                     , KC_NO   , KC_NO   , KC_P7       , KC_P8   , KC_P9   , KC_PMNS ,
    KC_NO , KC_NO   , KC_NO    , KC_NO   , KC_NO   , KC_NO                     , KC_UP   , KC_DOWN , KC_P4       , KC_P5   , KC_P6   , KC_PPLS ,
    KC_NO , KC_NO   , QK_BOOT  , KC_NO   , KC_NO   , KC_NO   , KC_NO , KC_TRNS , KC_LEFT , KC_RGHT , KC_P1       , KC_P2   , KC_P3   , KC_PEQL ,
