        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item Availability $=\frac{MTTF}{MTTF + MTTR}$, mean time to
                    failure/recovery.
                % \item 8 fallacies of Distributed Computing:
                %     \begin{itemize}
                %         \item Network is reliable
                %         \item Zero latency
                %         \item Bandwidth is infinite
                %         \item Network is secure
                %         \item Topology does not change
                %         \item Only one admin
                %         \item Transport is free
                %         \item Network is homogeneous
                %     \end{itemize}
